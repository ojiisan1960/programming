#!/bin/bash
#
# 7/10/14 modifed to use rsync server instead of ssh
...
#ROOT_DIRS="/bin /boot /etc /export /home /lib /root /sbin /usr /var /dev"
ROOT_DIRS="/bin /boot /etc /export /home /lib /root /sbin /usr /var"
